...
function User(name, email, password, age, gender, city, country) {
  ...
  var user1 = new User("Faiez", "faiez@gmail.com", "password123", 25, "Male", "Toronto", "Canada");
  var user2 = new User("Ali", "ali@gmail.com", "password456", 30, "Male", "New York", "USA");
  var user3 = new User("Emily", "emily@emily.com", "password789", 22, "Female", "London", "UK");
  console.log(user1);
  console.log(user2);
  console.log(user3);
